...
`pers.neige.PoemSuits.utils.ActionUtils`

`pers.neige.PoemSuits.utils.ConfigUtils`

`pers.neige.PoemSuits.utils.FileUtils`

`pers.neige.PoemSuits.utils.ItemUtils`

`pers.neige.PoemSuits.utils.JsonUtils`

`pers.neige.PoemSuits.utils.LangUtils`

`pers.neige.PoemSuits.utils.PlayerUtils`

`pers.neige.PoemSuits.utils.SamplingUtils`

`pers.neige.PoemSuits.utils.ScriptUtils`

`pers.neige.PoemSuits.utils.SectionUtils`

`pers.neige.PoemSuits.utils.StringUtils`

`pers.neige.PoemSuits.manager.HookerManager`

### 单例

`ActionManager` = `pers.neige.PoemSuits.manager.ActionManager.INSTANCE`

`ConfigManager` = `pers.neige.PoemSuits.manager.ConfigManager.INSTANCE`

`ItemEditorManager` = `pers.neige.PoemSuits.manager.ItemEditorManager.INSTANCE`

`ItemManager` = `pers.neige.PoemSuits.manager.ItemManager.INSTANCE`

`ItemPackManager` = `pers.neige.PoemSuits.manager.ItemPackManager.INSTANCE`
...
`plugin` = `pluginManager.getPlugin("PoemSuits")`

`player` 类型为`Player`, 代表触发此次物品动作的玩家

`itemStack` 类型为`ItemStack`, 代表触发此次物品动作的物品
