...
相关内容可以查看[物品保存指令](zhi-ling/wu-pin-bao-cun.md)。
...
如果你想要编辑物品lore、附魔等属性，请查看[物品配置](wu-pin/wu-pin-pei-zhi/README.md?id=物品配置)
...
你可以查看[物品获取](zhi-ling/wu-pin-huo-qu.md)了解get、give、giveAll的用法。
